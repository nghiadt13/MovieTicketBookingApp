...
class OpenApiConfig {
    ...
    fun customOpenAPI(): OpenAPI {
        val info =
                Info().title("Movie Ticket Backend API")
                        .version("v1")
                        .description(
                                """
        ...
        val servers = listOf(Server().url("http://localhost:8080").description("Local dev"))
        ...
        return OpenAPI()
                ...
                .tags(
                        listOf(
                                Tag().name("Movies")
                                        .description(
                                                "Movie catalogue endpoints: list, paged, get, create, update, soft delete."
                                        )
                        )
                )
                .externalDocs(
